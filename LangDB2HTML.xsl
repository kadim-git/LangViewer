				...
				<tr>
					<th>
						...
						<input type="button" value="Show/Hide Strategies"
							onclick="clickShowStrat('stratTablePronPoss')" />
					</th>
				</tr>
			</table>
		</div>

		<div class="stratTablePronPoss">
			<xsl:apply-templates select="../PronominalPossession/Strategy" />
		...
		<div class="nominPossHeader">
			...
			<table class="possTable">
				<tr>
					<th>
						Nominal Possession
						<input type="button" value="Show/Hide Strategies" onclick="clickShowStrat('nominPoss')" />
					</th>
				</tr>
				<tr class='nominPoss'>
					<td>Strategy</td>
